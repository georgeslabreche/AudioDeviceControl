...
namespace AudioDeviceControl.Wave
{
    ...
    internal class WaveInHelper
    {
        public static void Try(int err)
        {
            ...
            {
                // Let's just not throw any errors. A bad thing?
    ...
    {
        private static int RECORD_EVENT_WAIT_ONE_TIMEOUT = 1500;
        ...
        //private bool recordEventClosed = false;
        ...
        public void WaitFor()
        {
            ...
            if (m_Recording)
            {
                try
                {
                    m_Recording = m_RecordEvent.WaitOne(RECORD_EVENT_WAIT_ONE_TIMEOUT, false);
                }
    ...
    {
        private static int JOIN_TIMEOUT = 1500;
